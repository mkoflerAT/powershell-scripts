<#
    .SYNOPSIS
        Gets a Win11-machine ready for .NET development. Takes roughly 15min to install everything.
    ...
    .EXAMPLE
        Set-ExecutionPolicy Bypass -Scope Process -Force; iwr -useb 'https://tinyurl.com/Install-B550TUF' | iex

    .LINK
        https://kofler-it.com
        https://markuskofler.com
        https://
#>
...
$basicTools = @('7zip','brave','keepass','keepassxc','putty','signal','veracrypt','vlc','winscp')
...
# former extensions - not needed or trusted
