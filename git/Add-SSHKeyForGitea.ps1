...
#
# Don't forget to adapt $GitHostName and $GitHostDomain to your own domain!
# ==========================================================================
function Add-SSHKeyForGitea{
    $GitHostName="gitea.kofler-it.com"
    $GitHostDomain="gitea.kofler-it.com"
    $GitHostKeyUrl='https://gitea.kofler-it.com/user/settings/keys'
